...
type OfficeBuilding struct {
	...
	TenantCustomer *TenantCustomer `json:"tenant_customer" swaggo:"false,客户信息"`
	Contract       *Contract       `json:"contract" swaggo:"false,合同信息"`
	RentDetails    []RentDetail    `json:"rent_details" swaggo:"false,租金信息"`
}
