...
type Project struct {
	...
	Nature        *string `gorm:"column:nature;size:100;"`         // 资产性质
	Photo         *string `gorm:"column:photo;size:1024;"`         // 项目照片
	AssetType     *string `gorm:"column:asset_type;size:100;"`     // 资产类型
	Peripheral    *string `gorm:"column:peripheral;size:200;"`     // 周边配套
	BasicServices *string `gorm:"column:basic_services;size:200;"` // 基础服务
	Tag           *string `gorm:"column:tag;size:200;"`            // 特色标签
