...
type ICostBusiness interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.CostBusiness) error
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.CostBusiness) error
	// 删除数据
