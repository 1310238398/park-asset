...
type IBusinessPartner interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.BusinessPartner) error
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.BusinessPartner) error
	// 删除数据
