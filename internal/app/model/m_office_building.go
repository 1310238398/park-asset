...
type IOfficeBuilding interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.OfficeBuilding) error
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.OfficeBuilding) error
	// 删除数据
