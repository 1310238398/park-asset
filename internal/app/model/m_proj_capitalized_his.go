...
// IProjCapitalizedHis 项目资本化利息测算历史存储接口
type IProjCapitalizedHis interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.ProjCapitalizedHis) error
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.ProjCapitalizedHis) error
	// 删除数据
