...
type IBusinessFormat interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.BusinessFormat) error
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.BusinessFormat) error
	// 删除数据
