...
type IApartment interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.Apartment) (*schema.Apartment, error)
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.Apartment) (*schema.Apartment, error)
	// 删除数据
