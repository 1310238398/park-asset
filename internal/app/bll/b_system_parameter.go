...
type ISystemParameter interface {
	...
	// 创建数据
	Create(ctx context.Context, item schema.SystemParameter) (*schema.SystemParameter, error)
	// 更新数据
	Update(ctx context.Context, recordID string, item schema.SystemParameter) (*schema.SystemParameter, error)
	// 删除数据
