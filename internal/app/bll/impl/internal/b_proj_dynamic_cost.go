...
func NewProjDynamicCost(mTrans model.ITrans) bll.IProjDynamicCost {
...
func (a *ProjDynamicCost) QueryCostTree(ctx context.Context, projectID string) (schema.ProjDynamicCostTrees, error) {
