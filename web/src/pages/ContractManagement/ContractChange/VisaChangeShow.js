        ...
        <div className={styles.form}>
          <Card title="基本信息" style={{ marginBottom: 20 }}>
            ...
            <DescriptionList title="" size="large" col={1} style={{ marginBottom: 20 }}>
              <Description term="其他原因">
                {formDataVisaChange.reason_other}
              </Description>
              <Description term="签证内容">
                {formDataVisaChange.content}
              </Description>
            </DescriptionList>
            <DescriptionList title="" size="large" col={2} style={{ marginBottom: 20 }}>
              <Description term="签证报价">{formDataVisaChange.estimate}</Description>
              <Description term="施工单位负责人">{formDataVisaChange.working_company_charge}</Description>
            </DescriptionList>
            <DescriptionList title="" size="large" col={1} style={{ marginBottom: 20 }}>
            ...
            <DescriptionList title="" size="large" col={3} style={{ marginBottom: 20 }}>
              ...
              <Description term="发起日期">{moment(formDataVisaChange.launch_date).format('YYYY-MM-DD')}</Description>
            </DescriptionList>
          </Card>
          <Card title="监理与现场部信息" style={{ marginBottom: 20 }}>
            <DescriptionList title="" size="large" col={3} style={{ marginBottom: 20 }}>
              ...
              <Description term="是否设计出图">{formDataVisaChange.shejitu===1?'是':'否'}</Description>
