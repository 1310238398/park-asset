...
class AssetSubDoor extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.dispatch({
      type: 'assetHotelData/fetchSubDoor',
      search: { building_type: 4, project_id: projectID, parent_id: recordID },
      pagination: {},
    });

    this.dispatch({
      type: 'assetHotelData/fetchFormPlate',
  ...
  handleAddClick = () => {
    ...
    this.dispatch({
      type: 'assetHotelData/LoadSubDoor',
      payload: {
        type: 'A',
  ...
  handleFormCancel = () => {
    this.dispatch({
      type: 'assetHotelData/changeFormVisibleSubDoor',
      payload: false,
    });
  };
  ...
  handleFormSubmit = data => {
    this.dispatch({
      type: 'assetHotelData/submitSubDoor',
      payload: data,
    });
  ...
  handleDelOKClick(id) {
    this.dispatch({
      type: 'assetHotelData/delSubDoor',
  ...
  renderDataForm() {
    const {
      assetHotelData: { formTypeSubDoor },
      location: {
