...
class AssetNumPlate extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.dispatch({
      type: 'assetHotelData/fetchPlate',
      search: { building_type: 4, project_id: projectID, parent_id: recordID },
      pagination: {},
    });

    this.dispatch({
      type: 'assetHotelData/fetchFormFloor',
  ...
  handleFormCancel = () => {
    this.dispatch({
      type: 'assetHotelData/changeFormVisiblePlate',
      payload: false,
    });
  };
  ...
  handleFormSubmit = data => {
    this.dispatch({
      type: 'assetHotelData/submitPlate',
      payload: data,
    });
  ...
  onItemDetailClick = item => {
    this.dispatch({
      type: 'assetHotelData/subDoorRoute',
      payload: item,
    });
  };
