...
class AssetFloorData extends PureComponent {
  ...
  componentDidMount() {
    const {
      ...
      assetHotelData: { unitNum },
    } = this.props;
    this.dispatch({
      type: 'assetHotelData/fetchFloor',
    ...
    if (unitNum === 0) {
      ...
      this.dispatch({
        type: 'assetHotelData/fetchFormUnit',
        payload: { record_id: recordID },
      });
    }
  }
  ...
  handleFormCancel = () => {
    this.dispatch({
      type: 'assetHotelData/changeFormVisibleFloor',
      payload: false,
    });
  };
  ...
  handleFormSubmit = data => {
    this.dispatch({
      type: 'assetHotelData/submitFloor',
      payload: data,
    });
  ...
  onItemDetailClick = item => {
    ...
    this.dispatch({
      type: 'assetHotelData/plateRoute',
