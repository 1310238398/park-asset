...
import AssetCarDealerDataEdit from './AssetCarDealerDataEdit';
...
@connect(state => ({
  assetCarDealerData: state.assetCarDealerData,
  loading: state.loading.models.assetCarDealerData,
}))
@Form.create()
class AssetCarDealerData extends PureComponent {
  state = {
    selectedRowKeys: [],
    selectedRows: [],
    project_id: '',
  ...
  handleTableChange = pagination => {
    this.dispatch({
      type: 'assetCarDealerData/fetchCarDealer',
      pagination: {
  ...
  handleAddBuildClick = () => {
    ...
    if (project_id) {
      this.dispatch({
        type: 'assetCarDealerData/LoadCarDealer',
        payload: {
          type: 'A',
  ...
  handleFormBuildShow = () => {
    this.dispatch({
      type: 'assetCarDealerData/changeFormVisibleCarDealer',
      payload: false,
    });
    this.clearSelectRows();
  };
  ...
  handleFormSubmit = data => {
    const {
      assetCarDealerData: { formTypeCarDealer },
    } = this.props;
    this.dispatch({
      type: 'assetCarDealerData/submitCarDealer',
      payload: data,
    });
    if (formTypeCarDealer === 'E') {
      this.clearSelectRows();
    }
  };
  ...
  handleDelOKClick(id) {
    this.dispatch({
      type: 'assetCarDealerData/delCarDealer',
  ...
  handleChangePro = e => {
    ...
    this.dispatch({
      type: 'assetCarDealerData/saveProjectID',
      payload: e,
    });
  };
  ...
  renderDataForm() {
    ...
    if (formTypeCarDealer === 'A' || formTypeCarDealer === 'E') {
      return <AssetCarDealerDataEdit onCancel={this.handleFormCancel} onSubmit={this.handleFormSubmit} />;
    }
    // if (formTypeBuild === 'S') {
...
export default AssetCarDealerData;
