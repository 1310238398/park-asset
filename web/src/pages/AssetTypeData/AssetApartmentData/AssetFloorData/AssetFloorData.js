...
class AssetFloorData extends PureComponent {
  ...
  componentDidMount() {
    const {
      ...
      assetApartmentData: { unitNum },
    } = this.props;
    this.dispatch({
      type: 'assetApartmentData/fetchFloor',
    ...
    if (unitNum === 0) {
      ...
      this.dispatch({
        type: 'assetApartmentData/fetchFormUnit',
        payload: { record_id: recordID },
      });
    }
  }
  ...
  handleAddClick = () => {
    ...
    this.dispatch({
      type: 'assetApartmentData/LoadFloor',
      payload: {
        type: 'A',
  ...
  handleFormCancel = () => {
    this.dispatch({
      type: 'assetApartmentData/changeFormVisibleFloor',
      payload: false,
    });
  };
  ...
  handleFormSubmit = data => {
    this.dispatch({
      type: 'assetApartmentData/submitFloor',
      payload: data,
    });
  ...
  handleDelOKClick(id) {
    this.dispatch({
      type: 'assetApartmentData/delFloor',
  ...
  onItemDetailClick = item => {
    ...
    this.dispatch({
      type: 'assetApartmentData/plateRoute',
  ...
  renderDataForm() {
    const {
      assetApartmentData: { formTypeFloor },
      location: {
