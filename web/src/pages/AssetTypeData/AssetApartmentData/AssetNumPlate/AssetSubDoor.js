...
class AssetSubDoor extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.dispatch({
      type: 'assetApartmentData/fetchSubDoor',
      search: { building_type: 4, project_id: projectID, parent_id: recordID },
      pagination: {},
    });

    this.dispatch({
      type: 'assetApartmentData/fetchFormPlate',
  ...
  handleAddClick = () => {
    ...
    this.dispatch({
      type: 'assetApartmentData/LoadSubDoor',
      payload: {
        type: 'A',
  ...
  handleFormCancel = () => {
    this.dispatch({
      type: 'assetApartmentData/changeFormVisibleSubDoor',
      payload: false,
    });
  };
  ...
  handleFormSubmit = data => {
    this.dispatch({
      type: 'assetApartmentData/submitSubDoor',
      payload: data,
    });
  ...
  handleDelOKClick(id) {
    this.dispatch({
      type: 'assetApartmentData/delSubDoor',
  ...
  renderDataForm() {
    const {
      assetApartmentData: { formTypeSubDoor },
      location: {
